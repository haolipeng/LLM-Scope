...
export const en = {
  ...
  // AI Traffic
  'app.aiTraffic': 'AI Traffic',
  'aiTraffic.title': 'AI Traffic Details',
  'aiTraffic.loading': 'Loading...',
  'aiTraffic.error': 'Failed to load',
  'aiTraffic.empty': 'No AI traffic for this process',
  'aiTraffic.noResponse': 'No response',
  'aiTraffic.backToProcessTree': 'Back to Process Tree',
  'aiTraffic.pid': 'PID {pid}',
  'aiTraffic.viewTraffic': 'View AI Traffic',
  'aiTraffic.tabSummary': 'Summary',
  'aiTraffic.tabRawJSON': 'Raw JSON',
  'aiTraffic.request': 'Request',
  'aiTraffic.response': 'Response',
  'aiTraffic.model': 'Model',
  'aiTraffic.maxTokens': 'max_tokens',
  'aiTraffic.temperature': 'temperature',
  'aiTraffic.systemPrompt': 'System Prompt',
  'aiTraffic.messages': 'Messages',
  'aiTraffic.aiReply': 'AI Reply',
  'aiTraffic.toolUse': 'Tool Use',
  'aiTraffic.thinking': 'Thinking',
  'aiTraffic.noContent': 'No content',
  'aiTraffic.headers': 'Headers',
  'aiTraffic.body': 'Body',
  'aiTraffic.sseEvents': 'SSE Events',
  'aiTraffic.aiOnly': 'AI Traffic Only',
  'aiTraffic.allHTTP': 'All HTTP Traffic',
  'aiTraffic.emptyAll': 'No HTTP traffic recorded for this process',
  'aiTraffic.showAll': 'Show all HTTP traffic',
} as const;
